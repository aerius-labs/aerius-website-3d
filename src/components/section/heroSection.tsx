...
import { HankenGrotesk, AntonRegular } from '@/fonts/fonts';
...
export default function HeroSection({ loaded }: { loaded: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex ${AntonRegular.className} hovering relative flex-wrap gap-0 text-[35vw] font-extrabold leading-[35vw] sm:gap-10 sm:text-[32vw] sm:leading-[32vw] md:text-[20vw] md:leading-[20vw]`}
      >
      ...
      <div className='overflow-hidden'>
        <p
          className={`${HankenGrotesk.className} text-center text-sm sm:text-xl lg:text-2xl`}
          data-aos='slide-up'
          data-aos-delay='700'
        >
