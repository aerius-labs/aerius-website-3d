  ...
  return (
    <group ref={group} dispose={null}>
      <group name='Scene'>
        ...
        />
        {/* <group name="LEOMOON_LIGHT_STUDIO">
          <group name="LLS_PROFILE000">
            <group name="LLS_HANDLE" />
            <group name="LLS_LIGHT000">
              <group name="LLS_ROTATION" rotation={[Math.PI, -0.306, -1.815]}>
                <group
                  name="LLS_LIGHT_HANDLE"
                  position={[0, 30, 0]}
                  rotation={[-Math.PI / 2, 0, -Math.PI / 2]}>
                  <mesh
                    name="LLS_LIGHT_MESH000"
                    castShadow
                    receiveShadow
                    geometry={nodes.LLS_LIGHT_MESH000.geometry}
                    material={materials.LLS_light}
                    rotation={[-Math.PI, Math.PI / 2, 0]}
                  />
                </group>
              </group>
            </group>
            <group name="LLS_LIGHT001">
              <group name="LLS_ROTATION001" rotation={[0, 0.118, 1.71]}>
                <group
                  name="LLS_LIGHT_HANDLE001"
                  position={[0, 30, 0]}
                  rotation={[-Math.PI / 2, 0, -Math.PI / 2]}>
                  <mesh
                    name="LLS_LIGHT_MESH001"
                    castShadow
                    receiveShadow
                    geometry={nodes.LLS_LIGHT_MESH001.geometry}
                    material={materials['LLS_light.001']}
                    rotation={[-Math.PI, Math.PI / 2, 0]}
                  />
                </group>
              </group>
            </group>
            <group name="LLS_LIGHT002">
              <group name="LLS_ROTATION002" rotation={[0, 1.319, 0.761]}>
                <group
                  name="LLS_LIGHT_HANDLE002"
                  position={[0, 1.806, 0]}
                  rotation={[-Math.PI / 2, 0, -Math.PI / 2]}>
                  <mesh
                    name="LLS_LIGHT_MESH002"
                    castShadow
                    receiveShadow
                    geometry={nodes.LLS_LIGHT_MESH002.geometry}
                    material={materials['LLS_light.002']}
                    rotation={[-Math.PI, Math.PI / 2, 0]}
                  />
                </group>
              </group>
        ...
        <group
          name="Aestroid"
          position={[-0.636, -0.313, 0]}
          rotation={[0, 0, -Math.PI / 2]}
          scale={[0.054, 0.094, 0.054]}
        />
        <mesh
          name="Circle"
          castShadow
          ...
          position={[41.351, 0, 0]}
        />
        <group name="Path" position={[2.924, 7.118, 0]} />
        <mesh
          name="Stone"
          castShadow
          receiveShadow
          ...
          material={materials.Asteroid}
          position={[2.305, 5.827, 0]}
          rotation={[0, 0, -Math.PI / 2]}
        />
        <group
          name="Aestroid001"
          position={[-11.6, 6.519, -17.739]}
          rotation={[0, 0, -1.89]}
          scale={[0.054, 0.094, 0.054]}
        />
        <group
          name="Path001"
          position={[-4.853, 13.538, -17.739]}
          rotation={[0, 0, -0.319]}
          scale={1.182}
        />
        <group
          name="Aestroid002"
          position={[4.565, 2.701, -5.816]}
          rotation={[0, 0, -1.449]}
          scale={[0.054, 0.094, 0.054]}
        />
        <group
          name="Path002"
          position={[8.621, 14.748, -5.816]}
          rotation={[0, 0, 0.122]}
          scale={1.543}
        />
        <group
          name="Aestroid003"
          position={[-6.097, 1.352, -11.152]}
          rotation={[0, 0, -1.743]}
          scale={[0.054, 0.094, 0.054]}
        />
        <group
          name="Path003"
          position={[2.877, 13.957, -11.152]}
          rotation={[0, 0, -0.172]}
          scale={1.878}
        />
        <group
          name="Aestroid004"
          position={[16.794, -2.783, -29.548]}
          rotation={[0, 0, -1.265]}
          scale={[0.054, 0.094, 0.054]}
        />
        <group
          name="Path004"
          position={[20.218, 21.375, -29.548]}
          rotation={[0, 0, 0.306]}
          scale={2.961}
        /> */}
      </group>
